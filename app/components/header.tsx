...
function Header() {
  ...
  return (
    <div className="container w-full bg-[#F3F6F6] dark:bg-black lg:bg-transparent lg:dark:bg-transparent flex justify-between py-5 lg:px-4 lg:pt-[50px] text-black dark:text-white">
      ...
      <span
        onClick={toggleTheme}
        className="cursor-pointer rounded-full size-10 hover:bg-main ease-linear duration-150 flex justify-center items-center hover:scale-125 hover:rotate-[270deg]"
      >
